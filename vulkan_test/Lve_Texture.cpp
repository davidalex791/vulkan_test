...
namespace lve {
    Lve_Texture::Lve_Texture(LveDevice &device, const std::string &filepath) : lveDevice{device} 
    {
        int m_BytesPerPixel;
    ...
    void Lve_Texture::transitionImageLayout(VkImageLayout oldLayout, VkImageLayout newLayout) 
    {
    ...
    void Lve_Texture::generateMipmaps() 
    {
